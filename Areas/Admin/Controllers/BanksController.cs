...
namespace StaffManagement.Areas.Admin.Controllers
{
    public class BanksController : AdminBaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,AccountNumber,CreatedById,CreatedOn,ModifiedById,ModifiedOn")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,AccountNumber,CreatedById,CreatedOn,ModifiedById,ModifiedOn")] Bank bank)
        {
            if (id != bank.Id)
            {
                return NotFound();
